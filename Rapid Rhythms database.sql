...
INSERT INTO Attendance(Purchase_type, Payment_method, Payment_amount, Class_id, Transaction_Date)
VALUES ('bought month pass','cash',30,202201,'1-1-2022'),
('dance','cash',6,202201,'1-1-2022'),
('class and dance','check',10,202201,'1-10-2022'),
('class','cash',6,202201,'1-10-2022'),
('class and dance','card',10,202201,'1-17-2022'),
('used month pass for class and dance','free night',0,202201,'1-17-2022');
...
sum(case when a.Purchase_type = 'class' 
	or a.Purchase_type = 'used month pass for class' 
	or a.Purchase_type = 'class and dance' 
	or a.Purchase_type = 'used month pass for class and dance' then 1 else 0 end) Total_class_attendance,
sum(case when a.Purchase_type = 'dance' 
	or a.Purchase_type = 'used month pass for dance' 
	or a.Purchase_type = 'class and dance' 
	or a.Purchase_type = 'used month pass for class and dance' then 1 else 0 end) Total_dance_attendance,
...
from Attendance a	
where a.Transaction_date = '2022-01-07'; --this line is changed in the C# app;
